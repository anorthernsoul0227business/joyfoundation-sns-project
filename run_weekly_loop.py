...
思いつきメモでいただいたものです。無理に全部を使う必要はありませんが、
題材や言い回しに迷ったときはここから選んでください。

- **「音の森林浴」**（2026-09-04）
  自然音を聴く時間を表す言葉として使ってよい。効果の断言にはならない範囲で。
- **「聴覚は脳とつながり、心に一番近い五感」**（2026-09-04）
  音の話を始めるときの切り口として使える。ただし「心に一番近い」は
  一般に言われている表現として書き、研究の結論のようには書かないこと。

## 語尾を頼りなくしないこと（2026-09-04 圭一郎さんのご指摘）

「なのかも知れません」のような推量の語尾が続くと、やさしさではなく
**自信のなさ**に聞こえる、というご指摘をいただきました。

これは上の「効果を断言しない」とは**別の話**です。効果や結論を断言してはいけない
決まりはそのままです。ここで言っているのは、**断言してよいことまで
ぼかしてしまっている**という指摘です。

- **事実は言い切る**。「10分間聴いてもらいました」「7名の平均値です」
  →「〜のようです」「〜だったかもしれません」を付けない
- **研究の結果を紹介する形は言い切ってよい**。「〜という報告があります」は
  事実の記述であって断言ではない。「報告があるようです」とは書かない
- **私たちの読み取りは、これまでどおり読み取りとして書く**。
  「〜と私たちは読んでいます」「〜と考えています」は、語尾としては
  言い切りの形なのでこのままでよい
- **やわらげてよいのは、読み手の体験を推し量る部分だけ**。
  「そんな夜がある方もいらっしゃるかもしれません」はよい
- **推量の語尾は、1つの記事に1回まで**
  （かもしれません／のではないでしょうか／ように思います／でしょうか）
